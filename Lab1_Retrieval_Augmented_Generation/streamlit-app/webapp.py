...
# Currently we use the flan-t5-xl for text generation
# and all-MiniLM-L6-v2 for embeddings but in future we could support more
TEXT2TEXT_MODEL_LIST: List[str] = ["flan-t5-xl"]
EMBEDDINGS_MODEL_LIST: List[str] = ["all-MiniLM-L6-v2"]
...
if CFN_ACCESS is True:
    ...
    # running this app
    outputs: Dict = {}
    # REPLACE https://otp4466lah.execute-api.us-east-1.amazonaws.com/prod/ WITH ACTUAL API GW ENDPOINT URL
    outputs["LLMAppAPIEndpoint"] = "https://otp4466lah.execute-api.us-east-1.amazonaws.com/prod/"
...
# Page title
st.set_page_config(page_title='⚕️ HealthCare Chatbot ', layout='wide')
